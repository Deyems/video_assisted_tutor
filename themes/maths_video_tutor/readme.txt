...
Maths Video Tutor is fast, fully customizable & beautiful WordPress theme suitable for blog, personal portfolio, business website and WooCommerce storefront.

== Description ==

Maths Video Tutor is fast, fully customizable & beautiful WordPress theme suitable for blog, personal portfolio, business website and WooCommerce storefront. It is very lightweight (less than 50KB on frontend) and offers unparalleled speed. Built with SEO in mind, Maths Video Tutor comes with Schema.org code integrated and is Native AMP ready so search engines will love your site.
...
Looking for a perfect base theme? Look no further. Maths Video Tutor is fast, fully customizable and WooCommerce ready theme that you can use for building any kind of website!

== Installation ==

= From within WordPress =
1. Visit "Appearance > Themes > Add New"
2. Search for "Maths Video Tutor"
3. Install and activate

== License ==

Maths Video Tutor WordPress Theme, Copyright 2020 WPMaths Video Tutor.
Maths Video Tutor is distributed under the terms of the GNU GPL.

Maths Video Tutor is based on Underscores https://underscores.me/, (C) 2012-2020 Automattic, Inc.
Underscores is distributed under the terms of the GNU GPL v2 or later.

== Features ==

= Appearance > Widgets =
Maths Video Tutor has up to 4 widget area. 1 in your header, 1 for each sidebar and up to 2 in your footer.
...
= Maths Video Tutor Child Theme =

There are multiple ways you can use a child theme with the Maths Video Tutor Theme, Use any one method mentoned below to create a child theme or use a child theme we have created.

1. Download the child theme from Github - https://github.com/brainstormforce/Maths Video Tutor-child/releases/latest/
...
Maths Video Tutor icon font is based on IcoMoon-Free vector icon by Keyamoon.
...
Maths Video Tutor default breadcrumb is based on Breadcrumb Trail by Justin Tadlock. (https://github.com/justintadlock/breadcrumb-trail)
